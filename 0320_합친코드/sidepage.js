const tmp_data = [
  {
    user_id: 'woojin',
    user_profile: 'img/profile/user1.jfif',
    story: true,
    img_src: 'img/feedimg/airpot2.jfif',
    content: `에어팟을 잃어버렸습니다.. 찾아주신다면 어쩌구 저쩌구~~~어쩌구 저쩌구~~~어쩌구 저쩌구~~~어쩌구 저쩌구~~~어쩌구 저쩌구~~~어쩌구 저쩌구~~~어쩌구 저쩌구~~~어쩌구 저쩌구~~~어쩌구 저쩌구~~~어쩌구 저쩌구~~~어쩌구 저쩌구~~~어쩌구 저쩌구~~~`,
    likes: 21,
    comments: [
      { user_id: '김아무개', content: '저는 아무 것도 모릅니다' },
      { user_id: '박아무개', content: '저는 무엇인가를 알고 있습니다.' },
    ],
    upload_date: '2023-2-12',
  }];
      ...
      <section class="feed-body">
        <div class="feed-bar">
          <div class="bar-left">
            ...
            <img src="img/view_count.png" alt="view">
          </div>
          <div class="bar-right">
          </div>
        </div>
